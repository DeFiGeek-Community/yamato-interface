...
const BatteryContainer = ({ children }: { children: React.ReactNode }) => {
  return (
    <Box margin="auto" display="table">
      {children}
    </Box>
  );
};
const BatterySvgWrapper = ({ children }: { children: React.ReactNode }) => {
  return (
    <Box display="table-cell" textAlign="center" verticalAlign="middle">
      {children}
    </Box>
  );
};
  ...
  return (
    <Box border="2px solid #5bad92">
      <Box display="flex" alignItems="center" justifyContent="space-around">
        <Text fontSize="sm">{t("infographics.redemptionPool")}</Text>
      </Box>
      <BatteryContainer>
        <BatterySvgWrapper>
          {renderBattery(
      ...
      <Box display="flex" alignItems="center" justifyContent="space-around">
        <Text fontSize="sm">{t("infographics.liquidationPool")}</Text>
      </Box>
      <BatteryContainer>
        <BatterySvgWrapper>
